...
| 工作台 | 查询列表 |
| --- | --- |
| ![Lonear Admin 工作台](./docs/screenshots/Dashboard.png) | ![Lonear Admin 查询列表](./docs/screenshots/QueryList.png) |

| 菜单管理 | 深色模式 |
| --- | --- |
| ![Lonear Admin 菜单管理](./docs/screenshots/MenuManagement.png) | ![Lonear Admin 深色模式](./docs/screenshots/DashboardDark.png) |
