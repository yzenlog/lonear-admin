...
export type NotificationPlacement = "left" | "right";
...
type InternalNotification = Required<Pick<NotificationOptions, "type" | "duration" | "closable" | "placement">> & {
  id: string;
  title: ReactNode;
  description?: ReactNode;
...
function NotificationItem({
  ...
  return (
    ...
    >
      <span className="ui-notification-icon" aria-hidden="true">
        <NotificationIcon type={notification.type} />
      </span>
      <span className="ui-notification-copy">
...
export function NotificationProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <NotificationContext.Provider value={api}>
      {children}
      <div className="ui-notification-viewport ui-notification-viewport-left" aria-label="左侧通知">
        {leftNotifications.map((notification) => (
          <NotificationItem notification={notification} onClose={destroy} key={notification.id} />
        ))}
      </div>
      <div className="ui-notification-viewport ui-notification-viewport-right" aria-label="右侧通知">
