...
const enTranslations: Record<string, string> = {
  ...
  发送消息: "Send Message",
  发送: "Send",
  搜索聊天室: "Search chat rooms",
  聊天室频道: "Chat room channels",
  聊天室概览: "Chat room overview",
  当前在线: "Online now",
  今日消息: "Messages today",
  成员: "Members",
  更多操作: "More actions",
  ...
  "Emoji 面板": "Emoji panel",
  表情包面板: "Sticker panel",
  "插入 emoji": "Insert emoji",
  消息工具: "Message tools",
  发送文件: "Send file",
  发送图片: "Send image",
  "打开 emoji": "Open emoji",
  打开表情包: "Open stickers",
  个附件: "attachments",
  "可发送文字、文件、图片、表情包和 emoji": "Text, files, images, stickers, and emoji are available",
  "输入消息，和团队同步最新进展": "Write a message and share the latest progress",
  请输入消息内容或添加附件: "Enter a message or add an attachment.",
  消息已发送: "Message sent.",
  已发送表情包: "Sticker sent",
  运营协作: "Operations Collaboration",
  "活动、内容和公告上线节奏": "Launch rhythm for campaigns, content, and notices",
  设计评审: "Design Review",
  组件状态和页面走查反馈: "Component states and screen review feedback",
  客服同步: "Support Sync",
  "用户反馈、工单和紧急问题": "User feedback, tickets, and urgent issues",
  运营负责人: "Operations Lead",
  产品设计: "Product Design",
  已确认: "Confirmed",
  准备上线: "Ready to Launch",
  资料已备: "Materials Ready",
  稍后同步: "Sync Later",
  "已确认，继续推进": "Confirmed. Keep moving.",
  资料已备齐: "Materials are ready.",
  首页活动Banner已完成替换: "Homepage campaign banner has been replaced",
  "首页活动 Banner 已完成替换，等待最后一轮发布确认。": "The homepage campaign banner has been replaced and is waiting for the final publish confirmation.",
  "收到，发布前把落地页截图和素材包一起发到这里。": "Got it. Send the landing page screenshots and asset pack here before publishing.",
  "素材包和预览图已补齐，复核点只剩移动端顶部间距。": "The asset pack and preview images are ready. Only the mobile top spacing still needs review.",
  "表单错误态的红色在深色模式里更柔和了，组件展示页可以同步更新。": "The form error red is softer in dark mode, so the component showcase can be updated too.",
  "登录保护开关开启后，有 3 个老账号需要重新绑定邮箱。": "After login protection was enabled, 3 legacy accounts need to relink email addresses.",
  "先走站内信提醒，今晚再看未完成名单。": "Send an inbox reminder first, then review the unfinished list tonight.",
